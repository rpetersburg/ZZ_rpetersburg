...
##        self.drawLatex(leptonChannel, channelTextSize, luminosityStringList, luminosityTextSize, titleOffset)
    ...
    def setHistogramJets(self, jetHistogram, rootFileNames):
        jetFile = TFile("C:/Users/ryanrp/Documents/CERN/analysis/ZZ_haider/redBkg_smoothed.root", "read")
...
##        jetHistogram = TH1F('jetHistogram', 'Jet Histogram', self.nBins, self.lowerLimit, self.upperLimit)
...
##                currentHistogram.Scale(normNumber[yearIndex][channelIndex]/currentHistogram.Integral())
    ...
    def drawCombinedHistogram(self, histogramList, histogramNames, histogramOptions):
        combinedCanvas = TCanvas('combinedCanvas', 'combinedCanvas', 0, 0, 800, 800)
        combinedCanvas.cd()
    ...
    def run(self):
        ...
        self.mcJetBkgHistogram = TH1F( 'mcJetBkgHistogram', 'MC Jet Background Histogram', self.nBins, self.lowerLimit, self.upperLimit)
        ...
        self.mcZZBkgHistogram = TH1F( 'mcZZBkgHistogram', 'MC ZZ Background Histogram', self.nBins, self.lowerLimit, self.upperLimit)
        ...
        self.mcSignalHistogram = TH1F( 'mcSignalHistogram', 'MC Signal Histogram', self.nBins, self.lowerLimit, self.upperLimit )
        ...
        histogramColors
        histogramNames = ['Experimental Data', 'MC Background Jets', 'MC Background ZZ^{(*)}', 'MC Signal (m_{H} = 125 GeV)']
